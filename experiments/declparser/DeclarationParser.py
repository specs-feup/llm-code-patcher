...
def serializedATN():
    return [
        4,1,11,63,2,0,7,0,2,1,7,1,2,2,7,2,1,0,5,0,8,8,0,10,0,12,0,11,9,0,
        ...
        9,0,0,13,14,5,11,0,0,14,15,5,1,0,0,15,56,5,11,0,0,16,17,5,5,0,0,
        17,18,5,11,0,0,18,19,5,1,0,0,19,56,5,11,0,0,20,21,5,6,0,0,21,22,
        5,11,0,0,22,23,5,1,0,0,23,33,5,11,0,0,24,25,5,2,0,0,25,30,5,11,0,
        0,26,27,5,3,0,0,27,29,5,11,0,0,28,26,1,0,0,0,29,32,1,0,0,0,30,28,
        ...
        59,60,5,1,0,0,60,61,5,11,0,0,61,5,1,0,0,0,6,9,30,33,41,52,55
    ]
    ...
    def declaration(self):
        ...
        try:
            ...
            if token in [9]:
                ...
                self.state = 15
                localctx.typename = self.match(DeclarationParser.ID)
                pass
            elif token in [5]:
                ...
                self.match(DeclarationParser.T__0)
                self.state = 23
                localctx.return_typename = self.match(DeclarationParser.ID)
                self.state = 33
                self._errHandler.sync(self)
                _la = self._input.LA(1)
                if _la==2:
                    ...
                    localctx.arg_typenames.append(localctx._ID)
                    self.state = 30
                    self._errHandler.sync(self)
                    _la = self._input.LA(1)
                    while _la==3:
